...
import argparse
from util.preprocessing import perpareDataset, loadDatasetPickle, readCoNLL, remove_pkl_files,prepare_training_data, read_dict, get_target_task, build_vocab_from_domains, build_all_domain_term_dist, get_most_similar_domain, read_dict_data, set_target_task, build_indexes_from_domains
from keras import backend as K
from util.constants import  DATA_DIR, TASKS
...
idx = build_indexes_from_domains(TASKS)
